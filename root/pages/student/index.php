...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="navbar-brand color-set-1" href="../pages/student/"><h3 class="font-1"><i class="fas fa-tachometer-alt" style="padding-right: 10px"></i>Dashboard</h3></a>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow color-set-1" href="#profile"><i class="fa fa-user"></i></i>View Profile</a>                            
                        </li>
                        <li>
                            <a class="color-set-1" href="#courses"><i class="fas fa-book-reader"></i>Courses Subscribed</a>
                        </li>
                        <li>
                            <a class="color-set-1" href="#performance"><i class="zmdi zmdi-trending-up"></i>Performance</a>
                        </li>
                        <li>
                            <a class="color-set-1" href="#orders"><i class="fas fa-shopping-bag"></i>Order History</a>
                        </li>
                        <li>
                            <a class="color-set-1" href="map.html"><i class="fas fa-user-cog"></i>Settings</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow color-set-1" href="#"><i class="fas fa-copy"></i>Account</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a class="color-set-1" href="../../signin/forget-pass.html">Forget Password</a>
                                </li>
                                <li>
                                    <a class="color-set-1" href="../../signin/logout.php">Logout</a>
                                </li>
                                <li>
                                    <a class="color-set-1" href="../../signin/register.html">Close Accout</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a class="navbar-brand color-set-1" href="../pages/student/"><h2 class="font-1"><i class="fas fa-tachometer-alt" style="padding-right: 10px"></i>Dashboard</h2></a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow color-set-1" href="#profile"><i class="fa fa-user"></i>View Profile</a>
                        </li>
                        <li>
                            <a class="color-set-1" href="#courses"><i class="fas fa-book-reader"></i>Courses Subscribed</a>
                        </li>
                        ...
                        <li>
                            <a class="color-set-1" href="#"><i class="fas fa-user-cog"></i>Settings</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow color-set-1" href="#">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a class="color-set-1" href="../../signin/register.html">Close Account</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <div class="logo">
                                <h1 style="padding-left: 40px"><a class="navbar-brand color-set-1" href="../../pages/">Skill Wing</a></h1>
                            </div>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                        ...
                                        <div class="card-body">
                                            <div class="mx-auto d-block">
                                                ...
                                                <div class="location text-sm-center">
                                                    <i class="zmdi zmdi-email"></i><span class="email"><?php echo $email ?></span>
                                                </div>
                                            </div>
                                            <hr>
                                        </div>
                        ...
                        <div id="#courses" class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Courses Subscribed</h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php
                            $sql_searchcourses = "SELECT `course_id` FROM `student_subscriptions` WHERE `user_id`=$user_id";
                            $sql_courses = "SELECT * FROM `all_courses` WHERE `course_id` IN ($sql_searchcourses) ORDER BY `course_id`";
                            // echo "$sql_courses";
                            $totalcourses = 0;
                                    ...
                                    echo "
                                        <div class='col-md-4'>
                                            <div class='align-center'>
                                                <a href='../courses/' class='btn btn-outline-success'>Buy courses</a> 
                                            </div>
                                        </div>  
                                        ";
                                }
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2 id="#totalstudents"><?php echo $totalcourses ?></h2>
                                ...
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>0</h2>
                                                <span>Total Percent Completed</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                                ...
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2><i class="fas fa-rupee"></i>0</h2>
                                                <span>Total Career Investment</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
